...
//    private boolean initialized = false;
    ...
    private void createActiveComponent() 
    {
        try
        {
            ...
            ACRunnable componentRunnable = new ACRunnable(comp);
            //System.out.println("here 3");
            ACPortal portal = new ACPortal(componentRunnable);
	        ...
	        Context ctx = null;
	        	// new edu.uci.ece.doc.rtsjcomponents.example2.ContextImpl(this.id, 
    ...
    private void terminate() {   
        ...
        {        
          ...
          ACPortal portal = (ACPortal) thisScope.getPortal();
